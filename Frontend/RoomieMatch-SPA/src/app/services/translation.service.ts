...
export class TranslationService {
    ...
    private translations: Record<Language, Record<string, string>> = {
        en: {
            ...
            'profile.rentPeriod': 'Rent Period',
            'profile.selectPeriod': 'Select period',
            'profile.smokerPreference': 'Smoker Preference',
            'profile.noPreference': 'No preference',
            'profile.nonSmokerOnly': 'Non-smoker only',
            'profile.smokerOk': 'Smoker OK',
        ...
        da: {
            ...
            'profile.rentPeriod': 'Lejeperiode',
            'profile.selectPeriod': 'Vælg periode',
            'profile.smokerPreference': 'Ryger Præference',
            'profile.noPreference': 'Ingen præference',
            'profile.nonSmokerOnly': 'Kun ikke-ryger',
            'profile.smokerOk': 'Ryger OK',
